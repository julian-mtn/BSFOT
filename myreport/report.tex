...
Le transfert inconscient, que l'on nommera OT (Oblivious Transfer), 
est un 
...
De plus, le protocole OT classique n'est pas complet du point de vue des propriétés de sécurité, 
...
en utilisant $F(M)$ et $F(0)$ dans la randomisation sont
...
jeu dans lequel $F(0)$ est utilisée.
