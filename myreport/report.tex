...
\section{Construction du protocole}
...
\subsection{Vérification de la correctness}
...
\section{Aveuglement sous clés malveillantes}
...
\subsection{Preuve: Blindness du schéma de signature}
...
\transition{On remplace les preuves NIZK par des preuves simulées produites par un simulateur de type Subversion Zero-Knowledge (sub-ZK).}
...
\transition{On applique la propriété sub-ZK à la preuve NIZK de randomisation afin
...
Le remplacement de $F(M)$ par $F(\mathbf{0})$ est quand à lui justifié par
la simulation de la preuve NIZK grâce à la propriété sub-ZK.
...
\transition{On simule les composantes $\sigma_{1,i}$ de manière à les rendre indépendantes du message tout en conservant leur produit égal à $\sigma_1$.}
...
\transition{On utilise la propriété OT hiding pour montrer que la distribution des clés OT ne révèle aucune information sur le message.}
...
$\text{G}_2 \approx \text{G}_3.$

\transition{On remplace le message $m_0$ par le message $m_1$.}
...
\subsection{Preuve: randomisation de Waters}
