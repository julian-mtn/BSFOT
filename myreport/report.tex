...
Les seules branches déchiffrables correspondent aux branches DH
déterminées par le choix de l'utilisateur. Comme les valeurs
$(ek_{i,M_i},\widetilde{ek}_{i,M_i})=(g^{y_i},h^{y_i})$
sont distribuées uniformément grâce au choix uniforme de
$y_i\leftarrow\mathbb Z_p$, leur distribution est identique pour
$m_0$ et $m_1$.
La vue complète du signer est donc identique lorsque le message
signé est remplacé par $m_1$, c'est-à-dire
$
